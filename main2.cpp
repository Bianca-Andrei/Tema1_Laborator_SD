// varianta in care vectorul se genereaza direct, din fisier citindu-se doar valorile pentru n si maxim
#include <iostream>
#include <vector>
#include <fstream>
#include <chrono>
...
void generator(long n, long maxim, vector <long> &v)
{
    std::mt19937 rng(time(0));
    std::uniform_int_distribution<long> distr(0, maxim+1);
    for (long i=0; i<n; i++)
